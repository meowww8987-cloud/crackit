      ...
      >
        ...
        <div className="p-3 flex items-center gap-3">
          ...
          <button
            ...
            className="w-7 h-7 rounded-lg bg-white/5 flex items-center justify-center text-indigo-300/60 hover:text-white hover:bg-white/10 transition shrink-0"
          ...
          >
            ...
            >
                ...
                <div className="flex gap-2 justify-center">
                  {[
                    ...
                    <button
                      ...
                      className="flex-1 py-3 rounded-xl bg-white/5 hover:bg-white/10 transition flex flex-col items-center gap-1"
                    >
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-white/5 text-t-secondary text-sm font-medium"
              >
                Skip
              </button>
            </motion.div>
