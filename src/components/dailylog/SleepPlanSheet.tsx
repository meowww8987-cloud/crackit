        ...
        >
          ...
          >
            ...
            <div className="text-center mb-5">
              ...
              <p className="text-[11px] text-white/50 mt-0.5">Sustainable rhythm · 7-7.5h night sleep</p>
            </div>

            {/* === Daily schedule timeline === */}
            <h3 className="text-xs font-bold uppercase tracking-wide text-white/40 mb-2">Recommended Daily Schedule</h3>
            ...
            {/* === The 4 rules === */}
            <h3 className="text-xs font-bold uppercase tracking-wide text-white/40 mb-2">The 4 Rules</h3>
            <div className="space-y-2 mb-5">
              <RuleCard
                num="1"
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-white/50 leading-tight">{desc}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="glass rounded-xl p-3 flex gap-3">
      ...
      <div className="flex-1">
        ...
        <div className="text-[10px] text-white/60 leading-relaxed">{body}</div>
      </div>
    </div>
  );
}
