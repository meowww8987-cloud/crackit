...
export function SleepReportSheet({ open, onClose }: SleepReportSheetProps) {
 ...
 <p className="text-[11px] mt-0.5">Last 7 nights</p>
 </div>
 ...
 <div>
 <div className="text-[10px] uppercase tracking-wide font-semibold">Health Score</div>
 ...
 <div className="mb-4">
 <h3 className="text-xs font-bold uppercase tracking-wide mb-2 flex items-center gap-1">
 ...
 {n.quality != null && (
 <div className="text-[9px] ">{'★'.repeat(n.quality)}</div>
 )}
 </div>
 </div>
 );
 ...
 {/* === Recommendations === */}
 <div className="mb-2">
 <h3 className="text-xs font-bold uppercase tracking-wide mb-2">Recommendations</h3>
 <div className="space-y-1.5">
...
function StatCard({ icon, label, value, hint }: { icon: React.ReactNode; label: string; value: string; hint: string }) {
 ...
 <div className="flex items-center gap-1 text-[9px] uppercase tracking-wide font-semibold mb-1">
 {icon} {label}
 </div>
 <div className="text-base font-bold tabular">{value}</div>
 <div className="text-[9px] mt-0.5">{hint}</div>
 </div>
 );
}
