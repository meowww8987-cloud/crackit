        ...
        <details className="group">
          <summary className="flex items-center justify-between cursor-pointer text-xs">
            <span className="text-white/40">
              NEET 2027 Study Tracker · <span className="font-mono text-teal-400">v2.18.0</span>
            </span>
          ...
          <div className="mt-2 space-y-1.5 text-[10px] text-white/50 border-t border-white/5 pt-2">
            <div><strong className="text-white/70">v2.18.0</strong> — Sleep History moved to Tests long-press (3rd action). Sleep Reports (Weekly + Monthly) added to Stats long-press (3rd action). TabLongPressOverlay extended to support 3 actions (top/middle/bottom thirds). New SleepAnalysisSheet with Weekly/Monthly tabs: health score, 4 stat tiles, best+worst night, advantages (what's going well), disadvantages (what needs work), improvements (actionable). New SleepHistorySheet: full list of all sleep entries grouped by date with per-entry score. Removed Sleep History section from History tab.</div>
