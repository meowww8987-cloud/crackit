        ...
        <details className="group">
          <summary className="flex items-center justify-between cursor-pointer text-xs">
            <span className="text-white/40">
              NEET 2027 Study Tracker · <span className="font-mono text-teal-400">v2.9.1</span>
            </span>
          ...
          <div className="mt-2 space-y-1.5 text-[10px] text-white/50 border-t border-white/5 pt-2">
            <div><strong className="text-white/70">v2.9.1</strong> — Fix: app icon = Option F (Pulse/Heartbeat + Graduation Cap, not N7); splash screens = sequential (not random), 6 total, cycles 1→2→3→4→5→6→1</div>
