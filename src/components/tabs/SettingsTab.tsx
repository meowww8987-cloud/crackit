        ...
        <details className="group">
          <summary className="flex items-center justify-between cursor-pointer text-xs">
            <span className="text-white/40">
              NEET 2027 Study Tracker · <span className="font-mono text-teal-400">v2.18.1</span>
            </span>
          ...
          <div className="mt-2 space-y-1.5 text-[10px] text-white/50 border-t border-white/5 pt-2">
            <div><strong className="text-white/70">v2.18.1</strong> — Fix: Sleep History moved from Tests long-press → History tab long-press (alongside Test History, 2 options). Tests long-press reverted to CBT Mode + Practice Mode (2 options). Stats long-press order fixed: Weekly Report (top) → Monthly Report (middle) → Sleep Report (bottom). Sleep History + Sleep Analysis sheets redesigned with distinct dark indigo night-sky theme (twinkling stars, moon icon, indigo borders) so they look different from Test History + study Weekly/Monthly Reports.</div>
