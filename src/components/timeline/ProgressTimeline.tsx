              ...
              return (
                <div key={day.date}>
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wide text-white/60">{dayLabel}</span>
                    {dayDoneCount > 0 && (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5 mb-0.5">
                                ...
                                {e.lectureLabel && (
                                  <span className="text-[9px] font-bold text-white/40 tabular">{e.lectureLabel}</span>
                                )}
                                <span className="text-[9px] text-white/30 ml-auto tabular">{time}</span>
                              </div>
                              <div className={cn(
                                'text-xs truncate',
                                e.type === 'chapter_complete' ? 'font-bold text-purple-300' : 'text-white/80'
                              )}>
                                {e.topic}
                              </div>
